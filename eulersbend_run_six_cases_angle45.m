%% Run six specified Euler S-bend FDTD cases with total_angle_deg = 45
clc;
clear;
close all;
...
cases = repmat(base_para, 6, 1);
cases(1).W_in = 0.45; cases(1).W_out = 1.66; cases(1).R_min = 40;
cases(2).W_in = 0.45; cases(2).W_out = 1.66; cases(2).R_min = 50;
cases(3).W_in = 0.45; cases(3).W_out = 1.66; cases(3).R_min = 55;
cases(4).W_in = 1.66; cases(4).W_out = 0.45; cases(4).R_min = 40;
cases(5).W_in = 1.66; cases(5).W_out = 0.45; cases(5).R_min = 50;
cases(6).W_in = 1.66; cases(6).W_out = 0.45; cases(6).R_min = 55;
...
for i_case = 1:numel(cases)
    ...
    metric = parsed.T_list2_center;
    lambda_center_nm = parsed.lambda_center_nm;
    num_ports = parsed.num_ports_in_T_list;
    row_vals = parsed.T_list2_center_all;
    ...
    results(i_case).T_list2_center_all = row_vals;
...
save(fullfile(scriptFolder, 'six_case_results_angle45.mat'), 'results');
