%% Run two specified equal-width Euler S-bend FDTD cases at R_min=50
clc;
clear;
close all;
...
cases(1).W_in = 1.5; cases(1).W_out = 1.5; cases(1).R_min = 50;
cases(2).W_in = 1.6; cases(2).W_out = 1.6; cases(2).R_min = 50;
...
save(fullfile(scriptFolder, 'two_case_results_equal_width_r50.mat'), 'results');
...
for i_case = 1:numel(results)
    ...
    fprintf(' %.10f', results(i_case).T_list2_center_all);
    fprintf(' ]\n');
end
